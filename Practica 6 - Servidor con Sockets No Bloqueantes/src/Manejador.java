...
"		crossorigin=\"anonymous\"></script><title>Metodo " + metodo + "\n"
                + "</title></head><body class='bg-danger bg-opacity-10 container m-4'><center><h2>Parametros obtenidos por medio de " + metodo + "</h2><br>\n"
                + "<table class='table table-bordered'><tr><th>Parametro</th><th>Valor</th></tr>";
